...
values ('Vencimento Base', TRUE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Isencao de Horario Trabalho', TRUE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);
...
values ('Subsidio de Natal', TRUE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE);
...
values ('Subsidio de Ferias', TRUE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE);
*/
...
values ('Subsidio Refeicao', FALSE, 1, 0, 160.23, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Ajudas de Custo', FALSE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Cheques Creche', FALSE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Seguro de Saude Colaborador', FALSE, 1, 0, 24.57, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Seguro de Saude Familia', FALSE, 0.5, 0.5, 24.57, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Viatura', FALSE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Premio', FALSE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Comunicacoes', FALSE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Telemovel', FALSE, 1, 0, 0.03, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

insert into salaryitem(salaryitem_name, istaxed, firmcostrate, employeecostrate, defaultvalue, startdate, percentvalue, incauto, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec) 
values ('Computador', FALSE, 1, 0, 0, current_timestamp, 0, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);
